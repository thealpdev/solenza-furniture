    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto px-4 py-16 relative z-10 text-center">
          <div className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-white font-bold">Bize Ulaşın</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
            İletişime <span className="text-yellow-300">Geçin</span>
          </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">Bizi arayın</p>
            ...
            <div className="bg-gradient-to-br from-green-500 to-emerald-600 rounded-2xl p-6 shadow-lg text-white">
              ...
              <p className="text-white/80 text-sm mb-4">Hızlı destek için</p>
              <a
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm mb-3">Bize yazın</p>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <p className="text-gray-600 text-sm">
                Örnek Mahallesi, Mobilya Caddesi<br />
      ...
      <section className="bg-white py-12 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-2xl font-bold text-center mb-8 text-gray-900">Çalışma Saatlerimiz</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="text-center p-6 bg-gray-50 rounded-xl">
              <div className="text-3xl mb-3">🕐</div>
              <h3 className="font-bold text-gray-900 mb-2">Hafta İçi</h3>
